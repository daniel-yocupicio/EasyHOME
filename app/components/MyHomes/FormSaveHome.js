        ...
        <View style={styles.viewForm}>
            ...
            <Input
                ...
                rightIcon={{
                    ...
                    onPress: () => {setIsVisibleMap(true),setLocationHomeAddress(locationHome)},
                }}
            />
...
function UploadImage(props) {
    ...
    const { toastRef, setImageSelected, imageSelected, setIsLoading } = props;
    const imageSelect = async () => {
    ...
    return (
        <View style={styles.images}>
            <Icon type="material-community" name="camera" color="#2471A3" style={styles.icon} size={40}
                onPress={() => imageSelect()}
            />
            {
                imageSelected.map(uri=>{
                    <Text>a</Text>
                })
            }
        </View>
